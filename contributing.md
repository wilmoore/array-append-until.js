# Contributing to array-append-until

Below are a few ways to make contributing to `array-append-until` smoother.
...
## Setup
    ...
    git clone https://github.com/wilmoore/array-append-until.js.git
    cd array-append-until.js
    npm install
    npm run dev
